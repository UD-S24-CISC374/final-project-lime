...
export default class LoadingScene5 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("5cutscene", "assets/Backgrounds/5Cutscene1.png");
    }
    ...
    create() {
        ...
        this.add.image(640, 360, "5cutscene").setDisplaySize(1280, 720);
        ...
        this.input.keyboard?.on("keydown-ENTER", () => {
            if (this.contentFullyDisplayed) {
                ...
                this.cameras.main.once(
                    ...
                    () => {
                        this.scene.start("LoadingScene5part2", {
    ...
    resetScene() {
        ...
        this.content = ["Alfred! I'm here to save you and take down Namuh."];
    }
