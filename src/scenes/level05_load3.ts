...
export default class LoadingScene5part3 extends Phaser.Scene {
    ...
    preload() {
        this.load.image("namuhicon", "assets/Characters/namuhicon.png");
        this.load.image("5cutscene3", "assets/Backgrounds/5Cutscene3.png");
    }
    ...
    create() {
        ...
        this.add.image(640, 360, "5cutscene3").setDisplaySize(1280, 720);
        this.add.image(250, 635, "namuhicon").setDisplaySize(130, 130);
        ...
        this.input.keyboard?.on("keydown-ENTER", () => {
            if (this.contentFullyDisplayed) {
                ...
                this.cameras.main.once(
                    ...
                    () => {
                        this.scene.start("LoadingScene5part4", {
    ...
    resetScene() {
        ...
        this.content = [
            this.username +
                " you have no chance escaping this.\n\nThe power that me and Alfred hold\ntogether is unstoppable.",
        ];
    }
